...
const init = () => {
    ...
    loader.load('/assets/women.gltf', (gltf) => {
        ...
        watchEffect(() => {
            ...
            textureLoader.load(currentImg.value, (texture) => {
                ...
                context.fillStyle = 'rgba(0, 0, 0, 1)'; // Set transparent background
                ...
                const decalGeometry = new DecalGeometry(mesh, new THREE.Vector3(0, 0.4, 1), new THREE.Euler(-0.6, 0, 0), new THREE.Vector3(2, 2, 2));
